(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('angularjstexteditor', ["rangy","rangy/lib/rangy-selectionsaverestore"], function (a0,b1) {
      return (root['angularjstexteditor.name'] = factory(a0,b1));
    });
    ...
    root['angularjstexteditor'] = factory(rangy);
  }
}(this, function (rangy) {
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', '$log',
    ...
    if ((taOptions.forceTextAngularSanitize===true) && (gv.version !== 'taSanitize')) {
        throw angular.$$minErr('angularjstexteditor')("angularjstexteditorSetup", "The angularjstexteditor-sanitize provider has been replaced by another -- have you included angular-sanitize by mistake?");
    }
    taRegisterTool("html", {
...
"use strict";// NOTE: angularjstexteditorVersion must match the Gruntfile.js 'setVersion' task.... and have format v/d+./d+./d+
var angularjstexteditorVersion = 'v1.5.16';   // This is automatically updated during the build process to the current release!
...
// Global to angularjstexteditor to measure performance where needed
/* istanbul ignore next: untestable browser check */
...
// Global to angularjstexteditor REGEXP vars for block and list elements.
...
angular.module('angularjstexteditor.factories', [])
...
angular.module('angularjstexteditor.validators', [])
...
angular.module('angularjstexteditor.taBind', ['angularjstexteditor.factories', 'angularjstexteditor.DOM'])
...
.directive('taBind', [
        ...
        '_taBlankTest', '$parse', 'taDOM', 'angularjstexteditorManager',
        function(
            taSanitize, $timeout, $document, taFixChrome, taBrowserTag,
            taSelection, taSelectableElements, taApplyCustomRenderers, taOptions,
            _taBlankTest, $parse, taDOM, angularjstexteditorManager){
    ...
    return {
        ...
        link: function(scope, element, attrs, controller){
            ...
            // mappings is an array of maps from events to specialKeys as declared in angularjstexteditorSetup
            var _keyMappings = [
                //		ctrl/command + z
                {
                    specialKey: 'UndoKey',
            ...
            var _compileHtml = function(){
                ...
                throw ('angularjstexteditor Error: attempting to update non-editable taBind');
            };
            ...
            // because angularjstexteditor is bi-directional (which is awesome) we need to also sanitize values going in from the server
                ...
                if(!_isContentEditable){
                        ...
                        if(text && text.trim().length){
                            ...
                            if(text.match(/class=["']*Mso(Normal|List)/i) || text.match(/content=["']*Word.Document/i) || text.match(/content=["']*OneNote.File/i)){
                                ...
                                if(text.match(/<[^>]*?(ta-bind)[^>]*?>/)){
                                    // entire angularjstexteditor or ta-bind has been pasted, REMOVE AT ONCE!!
                                    if(text.match(/<[^>]*?(angularjstexteditor)[^>]*?>/)){
                    ...
                    element.on('keydown', scope.events.keydown = function(event, eventData){
                        ...
                        if ((typeof event.specialKey !== 'undefined') && (
                            ...
                            event.preventDefault();
                            angularjstexteditorManager.sendKeyCommand(scope, event);
                        }
                    ...
                    if(attrs.placeholder && (_browserDetect.ie > 8 || _browserDetect.ie === undefined)){
                        ...
                        else throw('angularjstexteditor Error: An unique ID is required for placeholders to work');
...
var dropFired = false;
var angularjstexteditor = angular.module("angularjstexteditor", ['ngSanitize', 'angularjstexteditorSetup', 'angularjstexteditor.factories', 'angularjstexteditor.DOM', 'angularjstexteditor.validators', 'angularjstexteditor.taBind']); //This makes ngSanitize required
...
return angularjstexteditor.name;
