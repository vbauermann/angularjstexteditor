...
angular.module('angularjstexteditorSetup', [])
    ...
    .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sce', 'taOptions', '$log',
        function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sce, taOptions, $log) {

            taOptions.angularjstexteditorSanitize == false;
            taRegisterTool("html", {
            ...
            taRegisterTool('insertVideo', {
                ...
                action: function () {
                    ...
                    if (blockJavascript(urlPrompt) == false)
                        return;
                    if (urlPrompt && urlPrompt !== '' && urlPrompt !== 'https://') {
                        const safeURl = $sce.trustAsResourceUrl(urlPrompt);
                        console.log(safeURl);
                        let embed = `<iframe src="${safeURl}" 
                                        width="640"
                                        height="268" 
                                        frameborder="0" 
