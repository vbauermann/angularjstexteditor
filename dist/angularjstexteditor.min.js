! function (a, b) {
    ...
    angular.module("angularjstexteditorSetup", []).constant("taRegisterTool", c).value("taTools", e).value("taOptions", {
        ...
        classes: {
            ...
            toolbarButton: "btn btn-default btn-angular-text",
        ...
        a("insertImage", {
            ...
            display: '<div id="toolbarWC" style="display:block; min-width:100px; pointer-events: none;">Words: <span ng-bind="wordcount"></span></div>',
            disabled: !0,
            wordcount: 0,
            ...
            display: '<div id="toolbarCC" style="display:block; min-width:120px; pointer-events: none;">Characters: <span ng-bind="charcount"></span></div>',
            disabled: !0,
            charcount: 0,
            activeState: function () { // this fires on keyup
                var a = this.$editor().displayElements.text,
