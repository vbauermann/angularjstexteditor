! function (a, b) {
    "function" == typeof define && define.amd ?
        ...
        define("angularjstexteditor", ["rangy", "rangy/lib/rangy-selectionsaverestore"], function (c, d) {
            return a["angularjstexteditor.name"] = b(c, d)
        }) : "object" == typeof exports ?

            module.exports = b(require("rangy"), require("rangy/lib/rangy-selectionsaverestore")) : a.angularjstexteditor = b(rangy)
}(this, function (a) {
    function b(a) {
        try {
    ...
    function c(a, c) {
        if (!a || "" === a || e.hasOwnProperty(a)) throw "angularjstexteditor Error: A unique name is required for a Tool Definition";
        if (c.display && ("" === c.display || !b(c.display)) || !c.display && !c.buttontext && !c.iconclass) throw 'angularjstexteditor Error: Tool Definition for "' + a + '" does not have a valid display/iconclass/buttontext value';
        e[a] = c
    }
    ...
    var e = {};
    angular.module("angularjstexteditorSetup", []).constant("taRegisterTool", c).value("taTools", e).value("taOptions", {
        ...
        toolbar: [
            ...
            "html", "insertImage", "insertLink", "insertVideo", "fontsize", "fontcolor", "markword", 
            "wordcount", "charcount"]
        ],
        classes: {
            focussed: "focussed",
        ...
        justifyLeft: {
            tooltip: "Texto alinhado à esquerda"
        },
        justifyRight: {
            tooltip: "Texto alinhado à direita"
        },
        justifyFull: {
        ...
        insertLink: {
            tooltip: "Inirir / Editar link",
            dialogPrompt: "Por favor insira a URL do link"
        },
        editLink: {
            reLinkButton: {
                tooltip: "Relink"
            ...
            targetToggle: {
                buttontext: "Abrir nova janela"
            }
        },
        wordcount: {
            tooltip: "Quantidade de palavas"
        },
        charcount: {
        ...
        fontsize: {
            ...
            dialogPrompt: "Por favor insira o tamanho da fonte em pixels"
        },
        fontcolor: {
            tooltip: "Cor da fonte",
            dialogPrompt: "Por favor insira a cor em formato hexadecimal"
        },
        markword: {
            tooltip: "Cor de destaque",
            dialogPrompt: "Por favor insira a cor para destacar em formato hexadecimal"
        }
        ...
        return {
            ...
            extractVideoURL: function (a) {
                // var b = /(?:youtube(?:-nocookie)?\.com\/(?:[^\/\n\s]+\/\S+\/|(?:v|e(?:mbed)?)\/|\S*?[?&]v=)|youtu\.be\/)([a-zA-Z0-9_-]{11})/i,
                //     c = a.match(b);
                // return c && c[1] || null
                a = a.indexOf("watch?v=") > -1 ? a.replace('watch?v=', 'embed/') : a;
                a = a.indexOf("youtu.be") > -1 ? a.replace('youtu.be', 'www.youtube.com/embed') : a;
                return a;
            },
            extractFontSize: function (a) {
                return a;
            },
            extractFontColor: function (a) {
                if (a.indexOf('#') === 0)
                    return a;
                else
                    alert('Deve-se colocar "#" na frente do código da cor');
            },
            extractMarkWord: function (a) {
                if (a.indexOf('#') === 0)
                    return a;
                else
                    alert('Deve-se colocar "#" na frente do código da cor');
        ...
        if (f("", i), g.forceTextAngularSanitize === !0 && "taSanitize" !== i.version) throw angular.$$minErr("angularjstexteditor")("angularjstexteditorSetup", "The angularjstexteditor-sanitize provider has been replaced by another -- have you included angular-sanitize by mistake?");
        a("html", {
        ...
        a("insertImage", {
            ...
            action: function () {
                ...
                if (a = b.prompt(c.insertVideo.dialogPrompt, "https://"), !l(a) && a && "" !== a && "https://" !== a && (videoUrl = e.extractVideoURL(a), videoUrl)) {
                    // create the embed link
                    g = '<iframe class="angularjsTextEditorVideo border-0" width="640" height="360" src="' + videoUrl + '" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>';
            ...
            action: function () {
                ...
                if (
                    ...
                    a = d.getSelectionElement().tagName && "a" === d.getSelectionElement().tagName.toLowerCase() ? b.prompt(c.insertLink.dialogPrompt, d.getSelectionElement().href) : b.prompt(c.insertLink.dialogPrompt, "http://"), a && "" !== a && "http://" !== a && !l(a)) return this.$editor().wrapSelection("
                    ", a, !0)
            },
            activeState: function (a) {
            ...
            display: '<div id="toolbarWC" style="display:block; min-width:100px; pointer-events: none;">Palavras: <span ng-bind="wordcount"></span></div>',
            disabled: !0,
            wordcount: 0,
            ...
            display: '<div id="toolbarCC" style="display:block; min-width:120px; pointer-events: none;">Caracteres: <span ng-bind="charcount"></span></div>',
            disabled: !0,
            charcount: 0,
            activeState: function () { // this fires on keyup
                var a = this.$editor().displayElements.text,
            ...
            tooltiptext: c.fontsize.tooltip,
            iconclass: "fas fa-text-height",
            action: function () {
                if (a = b.prompt(c.fontsize.dialogPrompt, ""), !l(a) && a && "" !== a && "" !== a && (fontSize = e.extractFontSize(a), fontSize)) {
                    // return this.$editor().wrapSelection("font-size", fontSize)
                    return this.$editor().wrapSelection("font-size", fontSize)

                }
            },
            activeState: function () {
                return this.$editor().queryCommandState("font-size")
            },
        }), a("fontcolor", {
            tooltiptext: c.fontcolor.tooltip,
            iconclass: "fas fa-tint",
            action: function () {
                if (a = b.prompt(c.fontcolor.dialogPrompt, "#"), !l(a) && a && "" !== a && "#" !== a && (fontColor = e.extractFontColor(a), fontColor)) {
                    return this.$editor().wrapSelection("color", fontColor);
                }
            },
        }), a("markword", {
            tooltiptext: c.markword.tooltip,
            iconclass: "fas fa-brush",
            action: function () {
                if (a = b.prompt(c.markword.dialogPrompt, "#"), !l(a) && a && "" !== a && "#" !== a && (markWord = e.extractMarkWord(a), markWord)) {
                    return this.$editor().wrapSelection("background-color", markWord);
                }
            }
        })
    ...
    */
    ...
    if (g.ie > 8 || void 0 === g.ie) {
        ...
        for (var r = document.styleSheets, s = 0; s < r.length; s++)
            if ((0 === r[s].media.length || r[s].media.mediaText.match(/(all|screen)/gi)) && r[s].href && r[s].href.match(/angularjstexteditor\.(min\.|)css/gi)) {
                l = r[s];
                break
            } /* istanbul ignore next: preference for stylesheet loaded externally */
        l || (
    ...
    angular.module("angularjstexteditor.factories", []).factory("taBrowserTag", [function () {
        return function (a) {
    ...
    }]), angular.module("angularjstexteditor.DOM", ["angularjstexteditor.factories"]).factory("taExecCommand", ["taSelection", "taBrowserTag", "$document", function (b, c, d) {
        var e = function (a, c) {
            var d, e, f = a.find("li");
                ...
                function (o, p, q, r) {
                    ...
                    if (y) {
                        ...
                        if ("insertorderedlist" === o.toLowerCase() || "insertunorderedlist" === o.toLowerCase()) {
                            ...
                            if ("font-size" === o.toLowerCase()) {
                                var O = '<span>',
                                P = '</span>',
                                Q = b.getSelection();
                                if(a.getSelection().getRangeAt(0).canSurroundContents()){
                                    var R = angular.element(O + P)[0];
                                    R.style.fontSize = (q + 'px').toString();
                                    a.getSelection().getRangeAt(0).surroundContents(R)
                                }
                                return
                                // y.style.fontSize = (q + 'px').toString();
                            }
                            if ("color" === o.toLowerCase()) {
                                var O = '<span>',
                                P = '</span>',
                                Q = b.getSelection();
                                if(a.getSelection().getRangeAt(0).canSurroundContents()){
                                    var R = angular.element(O + P)[0];
                                    R.style.color =(q).toString();
                                    a.getSelection().getRangeAt(0).surroundContents(R)
                                }
                                return
                            }
                            if("background-color" === o.toLowerCase()){
                                var O = '<span>',
                                P = '</span>',
                                Q = b.getSelection();
                                if(a.getSelection().getRangeAt(0).canSurroundContents()){
                                    var R = angular.element(O + P)[0];
                                    R.style.backgroundColor = (q).toString();
                                    a.getSelection().getRangeAt(0).surroundContents(R)
                                }
                                return
                            }
        ...
        return a
    }), angular.module("angularjstexteditor.validators", []).directive("taMaxText", function () {
        return {
            restrict: "A",
            require: "ngModel",
    ...
    }), angular.module("angularjstexteditor.taBind", ["angularjstexteditor.factories", "angularjstexteditor.DOM"]).service("_taBlankTest", [function () {
        return function (a) {
    ...
    }]).directive("taBind", ["taSanitize", "$timeout", "$document", "taFixChrome", "taBrowserTag", "taSelection", "taSelectableElements", "taApplyCustomRenderers", "taOptions", "_taBlankTest", "$parse", "taDOM", "angularjstexteditorManager", function (b, c, d, e, f, h, j, l, o, p, q, r, s) {
                ...
                if (
                    ...
                    if (f.events = {}, D) {
                                ...
                                if (a && a.trim().length) {
                                    ...
                                    if (a.match(/class=["']*Mso(Normal|List)/i) || a.match(/content=["']*Word.Document/i) || a.match(/content=["']*OneNote.File/i)) {
                                        ...
                                        if (
                                            ...
                                            if (a.match(/<[^>]*?(angularjstexteditor)[^>]*?>/)) {
                        ...
                        if (r.on("input", function () {
                            ...
                            var ja;
                            if (!u.id) throw "angularjstexteditor Error: An unique ID is required for placeholders to work";
    ...
    var t = !1,
        u = angular.module("angularjstexteditor", ["ngSanitize", "angularjstexteditorSetup", "angularjstexteditor.factories", "angularjstexteditor.DOM", "angularjstexteditor.validators", "angularjstexteditor.taBind"]); //This makes ngSanitize required
    return u.config([function () {
        // clear taTools variable. Just catches testing and any other time that this config may run multiple times...
        angular.forEach(e, function (a, b) {
            delete e[b]
        })
    }]), u.directive("angularjstexteditor", ["$compile", "$timeout", "taOptions", "taSelection", "taExecCommand", "angularjstexteditorManager", "$document", "$animate", "$log", "$q", "$parse", function (b, c, d, e, f, g, h, i, j, k, l) {
        return {
            require: "?ngModel",
            scope: {},
            restrict: "EA",
            ...
            link: function (m, n, o, p) {
                ...
                m._name = o.name ? o.name : "angularjstexteditorEditor" + C;
                ...
                if (
                    ...
                    var I = angular.element('<div angularjstexteditor-toolbar name="angularjstexteditorToolbar' + C + '">');
                    // passthrough init of toolbar options
                    o.taToolbar && I.attr("ta-toolbar", o.taToolbar), o.taToolbarClass && I.attr("ta-toolbar-class", o.taToolbarClass), o.taToolbarGroupClass && I.attr("ta-toolbar-group-class", o.taToolbarGroupClass), o.taToolbarButtonClass && I.attr("ta-toolbar-button-class", o.taToolbarButtonClass), o.taToolbarActiveButtonClass && I.attr("ta-toolbar-active-button-class", o.taToolbarActiveButtonClass), o.taFocussedClass && I.attr("ta-focussed-class", o.taFocussedClass), n.prepend(I), b(I)(m.$parent), x = g.registerEditor(m._name, m, ["angularjstexteditorToolbar" + C])
                }
    ...
    }]), u.service("angularjstexteditorManager", ["taToolExecuteAction", "taTools", "taRegisterTool", "$interval", "$rootScope", "$log", function (a, b, c, d, e, g) {
        ...
        return {
            ...
            registerEditor: function (c, d, e) {
                ...
                if (!c || "" === c) throw "angularjstexteditor Error: An editor requires a name";
                if (!d) throw "angularjstexteditor Error: An editor requires a scope";
                if (j[c]) throw 'angularjstexteditor Error: An Editor with name "' + c + '" already exists';
                return j[c] = {
                    scope: d,
                    toolbars: e,
            ...
            registerToolbar: function (a) {
                if (!a) throw "angularjstexteditor Error: A toolbar requires a scope";
                if (!a.name || "" === a.name) throw "angularjstexteditor Error: A toolbar requires a name";
                if (i[a.name]) throw 'angularjstexteditor Error: A toolbar with name "' + a.name + '" already exists';
                i[a.name] = a,
            ...
            updateToolbarToolDisplay: function (a, b, c) {
                if (!i[a]) throw 'angularjstexteditor Error: No Toolbar with name "' + a + '" exists';
            ...
            refreshEditor: function (a) {
                if (!j[a]) throw 'angularjstexteditor Error: No Editor with name "' + a + '" exists';
    ...
    }]), u.directive("angularjstexteditorToolbar", ["$compile", "angularjstexteditorManager", "taOptions", "taTools", "taToolExecuteAction", "$window", function (a, b, c, d, e, f) {
        return {
            scope: {
                name: "@"
            },
            restrict: "EA",
            link: function (g, h, i) {
                if (!g.name || "" === g.name) throw "angularjstexteditor Error: A toolbar requires a name";
    ...
    }]), u.directive("angularjstexteditorVersion", ["angularjstexteditorManager", function (a) {
        var b = a.getVersion();
        return {
            restrict: "EA",
            link: function (a, c, d) {
